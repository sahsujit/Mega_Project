...
//     let sectionCount=data.courseContent.length
//     let subSectionCount=data.courseContent.reduce((accumulator, currentValue) => accumulator + currentValue.subSection.length, 0)
...
//             </div>
//             <div className='text-[14px] font-medium text-yellow-50'><button onClick={handleExpandAll}>
//             Collapse all sections
//                 </button></div>
//           </div>
//           <div>
//             {
//                 data.courseContent.map((data)=>{
//                     return <Section section={data} collapse={collapse} setCollapse={setCollapse}></Section>
//                 })
//             }
//           </div>
//           <div className="mt-6">
...
//               <div className="text-richblack-5 text-[16px] font-medium">{data.instructor.firstName + " " +data.instructor.lastName}</div>
          
//             </div>
//             <div className="text-[14px] text-richblack-50">{data.instructor.additionalDetails.about}</div>
//            </div>
//     </div>
//   )
// }
